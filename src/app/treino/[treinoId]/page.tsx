...
export default async function Treino({
  ...
  return (
    <div className="flex flex-col justify-center items-center mx-auto w-screen h-full gap-2">
      <div className="flex justify-between w-full p-4 sticky top-0 bg-white">
        <Link href="/">
          <Undo2 />
        </Link>
        <h1>Exercícios</h1>
